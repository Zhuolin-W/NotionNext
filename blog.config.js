...
const BLOG = {
  AUTHOR: 'Zhuolin Wu', // 作者
  BIO: '一个怯懦的爱好者', // 作者简介
  LINK: 'https://blog-zhuolin-w.vercel.app/', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '80ccd707ae9345d6b74d98bf567854d2', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOHfAw0c4CPmhX', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://15znvr.deta.dev/', // Waline 评论 @see https://waline.js.org/guide/get-started.html
